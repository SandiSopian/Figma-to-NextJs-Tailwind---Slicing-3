export default function Contact() {
  return (
    <div className="lg:mt-4 flex">
      <section className="bg-white dark:bg-gray-900 lg:ml-0">
        <div className="py-8 lg:py-16 px-4 mx-auto h-[880px] sm:max-w-screen-sm">
          <h2 className="mt-12 mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us</h2>
